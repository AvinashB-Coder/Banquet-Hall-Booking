        ...
        <div className="card max-w-md w-full mx-4">
          ...
          >
            <div>
              ...
              <input
                type="email"
                defaultValue="admin@banquet.com"
    ...
    <div className="min-h-screen bg-secondary-50 flex">
      ...
      <aside className="w-64 bg-white border-r border-secondary-200 flex flex-col">
        <div className="p-6 border-b border-secondary-200">
          <h1 className="text-2xl font-bold text-primary-600">Banquet CRM</h1>
          <p className="text-sm text-secondary-500 mt-1">Booking Management</p>
        </div>
        ...
        <nav className="flex-1 p-4 space-y-2">
          ...
          <NavLink
            href="/halls"
            active={pathname === '/halls' || pathname?.startsWith('/halls/')}
            icon={
              <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div className="flex items-center gap-4">
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-secondary-500">admin@banquet.com</p>
                </div>
              </div>
            </div>
          </div>
